...
# ═══════════════════════════════════════════════════════════════
PREFIXES = ['.', '?']
WELCOME_GIF = 'https://media4.giphy.com/media/h9NjaxBkozXHBUPhEA/giphy.gif'
...
async def _nuke(ctx_or_inter):
    ...
    try:
        ...
        await new_ch.send(embed=success_embed('Channel Nuked', '💣 Channel has been nuked and recreated. RIP to every message that didn\'t make it out alive. Thoughts and prayers. 🕯️').set_image(url='https://media2.giphy.com/media/RMqdMPH9NJzz1wQsAF/giphy.gif'))
